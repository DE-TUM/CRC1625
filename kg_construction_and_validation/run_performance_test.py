...
prefixes = open(os.path.join(module_dir, './mappings_output_validation/queries/prefixes_validation.sparql')).read()
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=False,
        help="Path of the configuration file to be used across multiple executions. If not indicated, a new configuration file will be generated by querying the CRC1625 instance."
    )
    ...
    parser.add_argument(
        ...
        required=False,
        action="store_true",
        help="Run the performance test without materializing or doing anything RDF-related. The output will be the same, but will only reflect SQL-to-csv times."
    )
