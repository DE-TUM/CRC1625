...
FROM (
    ...
    compositionLocation.Value AS location,
    COUNT(DISTINCT ObjectLinkObject.LinkedObjectId) AS composition_count
    ...
    GROUP BY ObjectLinkObject.ObjectId, compositionLocation.Value
) AS t